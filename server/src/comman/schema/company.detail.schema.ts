...
// src/modules/company/schemas/company-address.schema.ts
import { Prop, Schema, SchemaFactory } from '@nestjs/mongoose';
import { Document, Types } from 'mongoose';
import { ApiProperty } from '@nestjs/swagger';
...
export class CompanyAddress {
  ...
  @ApiProperty({
    description: 'Associated company ID (for reference back)',
    example: '507f1f77bcf86cd799439011',
    required: false,
  })
  @Prop({ type: Types.ObjectId, ref: 'CompanyDetails' })
...
export type CompanyContactNumberDocument = CompanyContactNumber & Document;
...
export type CompanySocialMediaDocument = CompanySocialMedia & Document;
...
export class CompanyDetails {
  ...
  @ApiProperty({
    description: 'ID of the primary company address',
    example: '507f1f77bcf86cd799439012',
  })
  @Prop({ type: Types.ObjectId, ref: 'CompanyAddress', required: true })
  addressId: Types.ObjectId;

  @ApiProperty({
    description: 'IDs of additional company addresses (branches, offices, etc.)',
    example: ['507f1f77bcf86cd799439013'],
    required: false,
  })
  @Prop([{ type: Types.ObjectId, ref: 'CompanyAddress' }])
  additionalAddressIds?: Types.ObjectId[];

  @ApiProperty({
    description: 'IDs of company contact numbers',
    example: ['507f1f77bcf86cd799439014', '507f1f77bcf86cd799439015'],
  })
  @Prop([{ type: Types.ObjectId, ref: 'CompanyContactNumber' }])
  contactNumberIds: Types.ObjectId[];

  @ApiProperty({
    description: 'IDs of company social media profiles',
    example: ['507f1f77bcf86cd799439016', '507f1f77bcf86cd799439017'],
    required: false,
  })
  @Prop([{ type: Types.ObjectId, ref: 'CompanySocialMedia' }])
  socialMediaIds?: Types.ObjectId[];
...
CompanyDetailsSchema.index({ companyName: 1 }, { unique: true });