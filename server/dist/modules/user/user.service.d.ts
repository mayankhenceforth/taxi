...
import { PendingUserDocument, User, UserDocument } from 'src/comman/schema/user.schema';
...
export declare class UserService {
    ...
    private smsService;
    constructor(userModel: Model<UserDocument>, pendingUserModel: Model<PendingUserDocument>, tokenService: TokenService, cloudinaryService: CloudinaryService, smsService: SmsService);
    ...
    login(loginDto: LoginDto): Promise<{
        message: string;
        data: mongoose.Document<unknown, {}, UserDocument, {}, {}> & User & Document & {
            _id: mongoose.Types.ObjectId;
        } & {
            __v: number;
        };
    ...
    logout(userId: mongoose.Types.ObjectId): Promise<{
        message: string;
    }>;
