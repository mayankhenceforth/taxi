...
import { PendingUserDocument, UserDocument, DriverLicense, DriverLicenseDocument, VehicleDetails, VehicleDetailsDocument } from 'src/comman/schema/user.schema';
...
export declare class UserService {
    private userModel;
    private pendingUserModel;
    private driverLicenseModel;
    private vehicleDetailsModel;
    private tokenService;
    private cloudinaryService;
    private smsService;
    constructor(userModel: Model<UserDocument>, pendingUserModel: Model<PendingUserDocument>, driverLicenseModel: Model<DriverLicenseDocument>, vehicleDetailsModel: Model<VehicleDetailsDocument>, tokenService: TokenService, cloudinaryService: CloudinaryService, smsService: SmsService);
    ...
    sendUserVerificationOtp(userId: mongoose.Types.ObjectId): Promise<{
        message: string;
        otpSentTo: string;
    }>;
    userVerifiedUsingOtp(userId: mongoose.Types.ObjectId, otp: number): Promise<{
        message: string;
        data: {
            name: string;
            profilePic: string;
    ...
    logout(userId: mongoose.Types.ObjectId): Promise<ApiResponse<unknown>>;
    uploadProfilePic(userid: any, profilePicFile: Express.Multer.File): Promise<ApiResponse<string>>;
}
